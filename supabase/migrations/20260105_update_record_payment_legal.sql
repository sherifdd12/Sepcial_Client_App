-- Update record_payment function to support legal links and handle overpayments correctly
-- This version returns the payment ID and supports all necessary parameters
...
DROP FUNCTION IF EXISTS public.record_payment(UUID, NUMERIC, DATE, TEXT, TEXT, TEXT);
